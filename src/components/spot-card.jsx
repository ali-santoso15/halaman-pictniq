...
export function SpotCard({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "group relative min-h-[132px] overflow-hidden rounded-[26px] border text-left transition duration-300 md:min-h-[140px] lg:min-h-[158px]",
        selected
    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-between p-4 lg:p-[18px]">
        {prototype ? (
          <div className="flex h-full items-center justify-center">
            <p className="font-display text-[1.3rem] font-bold text-white md:text-[1.45rem] lg:text-[1.6rem]">
              {prototypeText}
            </p>
          </div>
        ) : (
