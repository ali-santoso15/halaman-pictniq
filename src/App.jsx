...
const navItems = [
  { label: "Beli tiket masuk PICTNIQ diTraveloka", href: "#spots" },
];
        ...
        <div className="container flex items-start justify-between py-3 md:py-4">
          <div className="flex flex-col gap-3">
            ...
            <Button
              variant="outline"
              size="icon"
              className="border-white/15 bg-black/15 backdrop-blur-md"
            ...
            <div className="container flex flex-col gap-3 py-4">
              {navItems.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="px-1 py-1 text-sm text-white/75 transition hover:text-white"
