...
const prototypeSpotSlides = [
  {
    id: "spot-slide-1",
    imageUrl: "/spot-slide-1.svg",
    caption: "Preview 01",
  },
  {
    id: "spot-slide-2",
    imageUrl: "/spot-slide-2.svg",
    caption: "Preview 02",
  },
  {
    id: "spot-slide-3",
    imageUrl: "/spot-slide-3.svg",
    caption: "Preview 03",
  },
];

const prototypeWahanaSlides = [
  {
    id: "wahana-slide-1",
    imageUrl: "/wahana-slide-1.svg",
    caption: "Wahana 01",
  },
  {
    id: "wahana-slide-2",
    imageUrl: "/wahana-slide-2.svg",
    caption: "Wahana 02",
  },
  {
    id: "wahana-slide-3",
    imageUrl: "/wahana-slide-3.svg",
    caption: "Wahana 03",
  },
];
...
function App() {
  ...
  const [activeSpotSlide, setActiveSpotSlide] = useState(0);
  const [activeWahanaSlide, setActiveWahanaSlide] = useState(0);

  const selectSpot = (spot) => {
    setSelectedSpot(spot);
    setActiveCaptionLang("id");
    setActiveSpotSlide(0);
  };

  const selectWahana = (wahana) => {
    setSelectedWahana(wahana);
    setActiveWahanaSlide(0);
  };
  ...
  return (
    <div className="min-h-screen bg-[#050608] text-white">
      <header className="fixed inset-x-0 top-0 z-40 bg-transparent">
        <div className="container flex items-start justify-between py-2.5 md:py-4">
          <a href="#journey" className="flex items-center gap-3">
            <div className="flex size-9 items-center justify-center overflow-hidden rounded-full border border-cyan-300/30 bg-white shadow-glow md:size-11">
              <img
            ...
            <div>
              <p className="font-display text-base font-bold uppercase tracking-[0.22em] text-white sm:text-lg sm:tracking-[0.28em]">
                PICTNIQ
              </p>
              <p className="text-[9px] uppercase tracking-[0.18em] text-white/55 sm:text-xs sm:tracking-[0.22em]">
      ...
      <main>
        <section
          id="journey"
          className="relative isolate overflow-hidden pb-12 pt-14 md:pb-20 md:pt-[72px]"
        >
          ...
          <div className="relative">
            <div className="flex flex-col items-center text-center">
              <div className="relative w-full overflow-hidden border-y border-white/10 bg-black/30 shadow-glow">
                ...
                <div className="relative flex min-h-[320px] flex-col items-center justify-center px-5 py-10 sm:px-10 md:min-h-[560px] md:px-12">
                  <div className="max-w-5xl space-y-4">
                    <h1 className="mx-auto max-w-[19rem] font-body text-[1.05rem] font-medium leading-[1.4] tracking-[0.01em] text-white sm:max-w-4xl sm:text-2xl md:text-[2.1rem] lg:text-[2.35rem]">
                ...
                >
                  <Card className="h-full border-white/10 bg-white/[0.03]">
                    <CardContent className="p-4 sm:p-5">
                      <div className="mb-4 flex size-11 items-center justify-center rounded-2xl border border-white/10 bg-white/5 sm:mb-5 sm:size-12">
                        <Icon className="size-5 text-cyan-200" />
                      </div>
                      <h3 className="font-display text-[1.35rem] font-bold text-white sm:text-[1.6rem]">
                        {item.title}
                      </h3>
                      <p className="mt-2 text-sm leading-6 text-white/66 sm:mt-3">
                        {item.description}
                      </p>
                    </CardContent>
                  </Card>
        ...
        <section id="spots" className="container pb-16 md:pb-24">
          <div className="mb-7 flex flex-col justify-between gap-4 lg:mb-10 lg:flex-row lg:items-end lg:gap-6">
            <div className="max-w-3xl space-y-4">
              <Badge>Explore Spots</Badge>
              <h2 className="max-w-[18rem] font-display text-[2rem] font-bold leading-[1.02] text-white sm:max-w-none sm:text-4xl md:text-5xl">
                Spot spot yang harus kamu tahu
              </h2>
            </div>
          </div>

          <div className="grid gap-3 sm:gap-4 lg:grid-cols-[0.78fr_1.22fr] xl:grid-cols-[0.74fr_1.26fr]">
            ...
            <div className="lg:sticky lg:top-24 lg:h-fit">
              <div className="relative min-h-[220px] overflow-hidden rounded-[28px] border border-white/10 bg-[#090b10] shadow-glow sm:min-h-[260px] lg:min-h-0 lg:rounded-[32px] lg:aspect-[4/5]">
                ...
                <div className="relative flex h-full p-4 md:p-5">
                  <PrototypeCarousel
                    title="View Spot"
                    slides={prototypeSpotSlides}
                    activeIndex={activeSpotSlide}
                    onChange={setActiveSpotSlide}
                    prevLabel="Previous spot photo"
                    nextLabel="Next spot photo"
                    accentClass={selectedSpot.accent}
                  />
                </div>
              </div>
            </div>
        ...
        <section id="wahana" className="container pb-16 md:pb-24">
          <div className="mb-7 flex flex-col justify-between gap-4 lg:mb-10 lg:flex-row lg:items-end lg:gap-6">
            <div className="max-w-3xl space-y-4">
              <Badge>List Wahana</Badge>
              <h2 className="max-w-[18rem] font-display text-[2rem] font-bold leading-[1.02] text-white sm:max-w-none sm:text-4xl md:text-5xl">
                wahana yang wajib kamu coba
              </h2>
            </div>
          </div>
            ...
            <div className="lg:sticky lg:top-24 lg:h-fit">
              <div className="relative min-h-[220px] overflow-hidden rounded-[28px] border border-white/10 bg-[#090b10] shadow-glow sm:min-h-[260px] lg:min-h-0 lg:rounded-[32px] lg:aspect-[4/5]">
                ...
                <div className="relative flex h-full p-4 md:p-5">
                  <PrototypeCarousel
                    title="View Wahana"
                    slides={prototypeWahanaSlides}
                    activeIndex={activeWahanaSlide}
                    onChange={setActiveWahanaSlide}
                    prevLabel="Previous wahana photo"
                    nextLabel="Next wahana photo"
                    accentClass={selectedWahana.accent}
                  />
                </div>
              </div>
            </div>
        ...
        <section id="visit" className="container pb-16 md:pb-24">
          <div className="mb-7 max-w-3xl space-y-4 lg:mb-10">
            <Badge>Visit Info</Badge>
            <h2 className="max-w-[17rem] font-display text-[2rem] font-bold leading-[1.02] text-white sm:max-w-none sm:text-4xl md:text-5xl">
              Intip jam buka kami
            </h2>
          </div>
          ...
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <Card className="overflow-hidden border-cyan-300/10 bg-white/[0.03]">
              <CardContent className="p-4 sm:p-6">
                <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[#0c1116] p-4 sm:rounded-[28px] sm:p-5">
                  ...
                  <div className="relative">
                    <div className="rounded-[22px] border border-white/10 bg-[linear-gradient(160deg,#0a1320,#06090d)] p-4 sm:rounded-[24px] sm:p-5">
...
function PrototypeCarousel({
  ...
  const goToPrev = () => {
    onChange((activeIndex - 1 + slides.length) % slides.length);
  };
    ...
    <div className="flex w-full flex-col gap-3 sm:gap-4">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <p className="text-[11px] uppercase tracking-[0.32em] text-white/40 sm:text-xs">Prototype Gallery</p>
          <h3 className="mt-1 font-display text-lg font-bold text-white sm:text-[1.45rem]">{title}</h3>
        </div>
        <div className="flex items-center gap-2 text-[11px] text-white/48 sm:text-xs">
          <span>{String(activeIndex + 1).padStart(2, "0")}</span>
          <span className="h-px w-4 bg-white/18 sm:w-6" />
      ...
      <div className="flex flex-1 flex-col gap-3 sm:gap-4">
        <div
          className="relative flex-1 overflow-hidden rounded-[24px] border border-white/10 bg-[#081018] sm:rounded-[26px]"
          onTouchStart={handleTouchStart}
          onTouchEnd={handleTouchEnd}
        >
          <div className={cn("absolute inset-0 bg-gradient-to-br opacity-30", accentClass)} />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(2,6,12,0.1),rgba(2,6,12,0.7))]" />
            ...
            {slides.map((slide) => (
              <div key={slide.id} className="relative min-w-full">
                <img
                  src={slide.imageUrl}
                  alt={slide.caption}
                  className="h-full min-h-[250px] w-full object-cover sm:min-h-[320px] lg:min-h-0"
                />
                <div className="absolute inset-x-0 bottom-0 bg-[linear-gradient(180deg,transparent,rgba(4,8,12,0.9))] px-4 pb-4 pt-12 sm:px-5 sm:pb-5">
                  <div className="inline-flex rounded-full border border-white/12 bg-black/20 px-3 py-1 text-[10px] uppercase tracking-[0.28em] text-white/68 sm:text-[11px]">
                    {slide.caption}
                  </div>
                </div>
              </div>
          ...
          <button
            ...
            className="absolute left-3 top-1/2 flex size-10 -translate-y-1/2 items-center justify-center rounded-full border border-white/12 bg-black/40 text-white/80 backdrop-blur-sm transition hover:border-white/30 hover:bg-black/55 sm:left-4 sm:size-11"
          >
          ...
          <button
            ...
            className="absolute right-3 top-1/2 flex size-10 -translate-y-1/2 items-center justify-center rounded-full border border-white/12 bg-black/40 text-white/80 backdrop-blur-sm transition hover:border-white/30 hover:bg-black/55 sm:right-4 sm:size-11"
          >
            ...
            {slides.map((slide, index) => (
              <button
                ...
                className={cn(
                  ...
                  activeIndex === index ? "w-10 bg-cyan-300 sm:w-12" : "w-2.5 bg-white/28 hover:bg-white/45",
                )}
              />
            ))}
          </div>
          <p className="text-center text-[11px] text-white/48 sm:text-right sm:text-xs">
            Geser atau klik panah untuk melihat 3 preview.
          </p>
        </div>
      </div>
    </div>
